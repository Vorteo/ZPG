...
DrawableObject* Factory::createAssimpObject(std::string filePath, const char* textureName, glm::mat4 transformationMatrix)
{
	...
	return new DrawableObject( (Model*) assimpModel, true, nullptr, new Transformation(transformationMatrix));
}
...
Scene* Factory::createComplexScene()
{
	...
	scene->addDrawableObject(this->createAssimpObject("AssimpModels/zombie/zombie.obj","AssimpModels/zombie/zombie.png", glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -1.0f, -10.0f))), PHONG_LIGHTS_TEXTURE);
	...
	scene->addDrawableObject(this->createAssimpObject("AssimpModels/wall/zed.obj", "AssimpModels/wall/bake.png", glm::translate(glm::mat4(1.0f), glm::vec3(-15.0f,-1.0f,10.0f))), PHONG_LIGHTS_TEXTURE);

	scene->addDrawableObject(this->createObject(1, glm::translate(glm::mat4(1.0f), glm::vec3(20.0f, 0.0f, 2.0f))), PHONG_LIGHTS);
