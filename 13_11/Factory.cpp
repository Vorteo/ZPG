...
Scene* Factory::createTextureScene()
{
	...
	scene->addDrawableObject(this->createObjectTexture(glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 3.0f)), "grass.png"));
	scene->addDrawableObject(this->createObjectTexture(glm::translate(glm::mat4(1.0f), glm::vec3(-3.0f, 0.0f, 0.0f)), "wooden_fence.png"));
...
{
	Scene* scene = new Scene();
	scene->addDrawableObject(this->createSkyBox());
