...
Scene::Scene()
{
	...
	this->spotLight = new SpotLight(glm::vec3(0.0f, -1.0f, 0.0f),glm::vec3(0.0f, 10.0f, 0.0f));
...
void Scene::drawSkyBox()
{
	...
	if (first && this->skyboxObject != nullptr)
	{
		this->first = false;
		M0 = glm::translate(M0, this->camera->getCameraPosition());;
	}
	...
	if (this->skyboxObject != nullptr)
	{
		...
		this->skyboxObject->setTransformation(M0);
