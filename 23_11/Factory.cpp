...
Scene* Factory::createSkyBoxScene()
{
	...
	scene->addDrawableObject(this->createObject(1, glm::translate(glm::mat4(1.0f), glm::vec3(2.0f, 1.0f, 0.0f))), PHONG);
	scene->addDrawableObject(this->createObject(1, glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 1.0f, 2.0f))), PHONG);
	scene->addDrawableObject(this->createObject(1, glm::translate(glm::mat4(1.0f), glm::vec3(-2.0f, 1.0f, 0.0f))), PHONG);
	scene->addDrawableObject(this->createObject(1, glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 1.0f, -2.0f))), PHONG);
