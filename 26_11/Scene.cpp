...
Scene::Scene()
{
	...
	this->assimp = new ShaderProgram("assimpShader.frag", "assimpShader.vert");
	...
	/*
	this->ligtsObjects.push_back(this->pointLight);
	this->ligtsObjects.push_back(this->directionalLight);
	this->ligtsObjects.push_back(this->spotLight);
	*/
}
